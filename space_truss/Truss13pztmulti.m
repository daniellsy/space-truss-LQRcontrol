<<<<<<< HEAD:space truss structures/Truss13pztmulti.m
%    定义平面杆系的有限元模型数据：
%        gNode ------- 结点定义
%        gElement ---- 单元定义
...
gMaterial = [7.27e10   6.283e-5   3100   0.3       % 横杆材料 1 (铝）
             7.27e10   6.283e-5   3100   0.3       % 竖杆材料 2 (铝）
             7.27e10   6.283e-5   3100   0.3];     % 斜杆材料 3（钢）
gpMaterial=[7600 7.07e-4 6.3e10 0.16 140 6.35e-10 1.5e-8 8000 6.283e-5 21e10 0.1];
%           roup    Ap     Ep    lp   np   d33     miup   rou    A       E    l
dx=0.3;%伸长方向上的一节的长度
dy=0.4;%宽度方向上一节的长度
m=21;%节数
...
frequency = frequency';
toc;
>>>>>>> fe89b73bf4649582b4302d802a27c4a9096320bd:space_truss/Truss13pztmulti.m
